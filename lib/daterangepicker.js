                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    if(this.annotationBands) {
                        for (var x = 0;x<this.annotationBands.length;x++) {
                            ...
                            if (calendar[row][col].isSame(moment(band.startDate, this.format)) || calendar[row][col].isSame(moment(band.endDate, this.format)) || calendar[row][col].isBetween(moment(band.startDate, this.format), moment(band.endDate, this.format))) {
                                cname += ' '+band.cssClass+' ';
                            }
                        }
                    }
