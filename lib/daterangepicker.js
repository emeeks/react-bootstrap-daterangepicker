                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    if(this.annotationBands) {
                        for (var x = 0;x<this.annotationBands.length;x++) {
                            ...
                            var bandStart = moment(band.startDate, this.format).startOf('day');
                            var bandEnd = moment(band.endDate, this.format).endOf('day');
                            console.log("annotationBand:", band);
                            console.log("date checked:", calendar[row][col]);
                            console.log("band start:", bandStart);
                            console.log("band end:", bandEnd);
