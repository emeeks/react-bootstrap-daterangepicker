  ...
  // Finally, as a browser global.
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            console.log(options.annotationBands);

            console.log(typeof options.annotationBands);
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, side) {
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    console.log(this.annotationBands);
                    if(this.annotationBands) {
                        for (var x = 0;x<this.annotationBands.length;x++) {
                            var band = this.annotationBands[x];
                            console.log(band);
                            if (calendar[row][col].isBefore(moment(band.endDate, this.format)) && calendar[row][col].isAfter(moment(band.startDate, this.format))) {
                                cname += ' in-band ';
                            }
                        }
                    }
